...
<div class="row" >
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="{{ route('editrole',['id'=>$value -> id])}}" ><i class="fas fa-edit"></i></a>
        &nbsp;
        <a href="{{ route('removerole',['id'=>$value -> id])}}" onclick="return confirm('Bạn có chắc chắn muốn xóa không?');"><i class="fas fa-trash-alt"></i></a>
        </td>
    </tr>
    @endforeach
    </tbody>
