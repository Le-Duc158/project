...
<div class="row">
  ...
  <div class="col-md-6" style="margin-top: 25px;">
    ...
    <div class="form-group">
        <label for="formGroupExampleInput2"  style="margin-left: 20px;">Google map</label>
        <input type="tetxt" class="form-control" id="map" name="map" style="width: 550px;margin-left: 15px;">
    </div>
