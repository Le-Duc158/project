...
Route::group(['prefix'=>'admin','middleware'=>'checkadmin'],function(){
    ...
    Route::group(['prefix'=>'adminuser'],function(){
        // thêm vai trò
        Route::get('addrole','ControllerRole@addrole')->name('addrole');
        Route::post('addrole','ControllerRole@postaddrole')->name('addrole');
        // danh sách vai trò
         Route::get('listrole','ControllerRole@listrole')->name('listrole');
        // xóa vai trò/ phân quyền
        Route::get('removerole/{id}','ControllerRole@removerole')->name('removerole');
         // sửa vai trò
        Route::get('editrole/{id}','ControllerRole@editrole')->name('editrole');
        Route::post('editrole/{id}','ControllerRole@posteditrole')->name('posteditrole');
    });
    // method pay
