				...
				<div class="row">
					...
					<div class="col-md-3">
						...
						<div class="row footer-img ">
							<div class=" sup-footer-img"><div class="img-footer"><img src="{{('public/frontend/imgs/footer-1.jpg')}}" alt=""></div></div>
							<div class=" sup-footer-img"><div class="img-footer"><img src="{{('public/frontend/imgs/footer-2.jpg')}}" alt=""></div></div>
							<div class=" sup-footer-img"><div class="img-footer"><img src="{{('public/frontend/imgs/footer-1.jpg')}}" alt=""></div></div>
							<div class=" sup-footer-img"><div class="img-footer"><img src="{{('public/frontend/imgs/footer-2.jpg')}}" alt=""></div></div>
							<div class=" sup-footer-img"><div class="img-footer"><img src="{{('public/frontend/imgs/footer-1.jpg')}}" alt=""></div></div>
							<div class=" sup-footer-img"><div class="img-footer"><img src="{{('public/frontend/imgs/footer-2.jpg')}}" alt=""></div></div>
