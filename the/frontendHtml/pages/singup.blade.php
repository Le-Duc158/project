	...
	<div class="wap-in">
		<div class="container">
			...
			<form  action="{{route('singup')}}" method="post" class="form-sign-up">
				@csrf
				...
				<div class="sign-up-input">
					<input type="checkbox"> &nbsp; <p  class="check-shipp-sign Sign-up2 " style="display: inline-block;">I agree to the <b>Terms,Privancy</b> and <b>Fees</b></p>
				</div>
